  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        <div
          className="absolute bottom-28 left-60 w-[110px] h-[80px] p-[6px] rounded-2xl bg-[#5D6680]"
        >
          <img
        ...
        <div
          className="absolute top-1/5 left-[65%] w-[110px] h-[80px] p-[6px] rounded-2xl bg-[#5D6680]"
        >
          <img
            src="planet-people-02.png"
            alt="planet"
            className="w-full h-full"
          />
        </div>
