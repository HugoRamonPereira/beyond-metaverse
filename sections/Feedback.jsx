  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      <motion.div
        ...
        className="flex-[0.5] lg:max-w-[370px] flex justify-evenly flex-col gradient-05 sm:p-8
      ...
      >
        ...
        <p className="mt-[24px] font-extralight sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white">
          &quot;With the development of today&apos;s technology, metaverse is very useful for
          today&apos;s work, or can be called web 3.0 by using metaverse you can use it as anything&quot;
        </p>
      </motion.div>
      <motion.div
